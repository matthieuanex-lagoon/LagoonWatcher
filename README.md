...
- **Deux champs s'alarment à la saisie.** L'alcool se teinte en jaune à un verre, orange à deux, rouge au-delà. Les calories se teintent dès qu'elles passent l'objectif : orange jusqu'à 300 kcal de dépassement, rouge au-delà. À l'objectif exactement, rien — il n'y a dépassement qu'au-dessus. La teinte se refait dans la surface du thème, donc elle tient en clair comme en sombre, et **elle ne porte jamais l'information seule** : le nombre saisi est visible, et l'écart calorique est écrit en clair sous le champ.
